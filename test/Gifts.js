...
describe('NFTGifting', function () {
    ...
    describe('Create a multiple gifts in one tx', function () {
        ...
        it('Should make 3 gifts at once', async function () {
            ...
            const gifts3 = [ethers.utils.solidityKeccak256(['string'], ['pass1']), ethers.utils.solidityKeccak256(['string'], ['pass2']), ethers.utils.solidityKeccak256(['string'], ['pass3'])]
        ...
        describe('Claim gifts from a bundle', function () {
            var lastGiftID
