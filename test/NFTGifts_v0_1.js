...
describe('NFT Gifts v0.1 - Remove IDs from functions, look for them instead', function () {
  ...
  async function deployTokenFixture() {
    ...
    NFTGifts = await ethers.getContractFactory('NFTGifts_v0_1');
  ...
  describe('Create a gift', function () {
    ...
    it('Should make gifts #1, #2 and #3 ', async function () {
      ...
      expect((await giftContract.getGift(code('1'))).claimed).to.equal(false);
    });
    ...
    describe('Reading data', function () {
      ...
      it('Should return correct data from getGift', async function () {
        ...
        expect((await giftContract.getGift(code('2'))).giftID).to.equal(2);
  ...
  describe('Cancel a gift', function () {
    ...
    describe('Events', function () {
      it('Should emit matching GiftCancelled event', async function () {
        await expect(tx).to.emit(giftContract, 'GiftCancelled').withArgs('4');
      });
    });
  ...
  describe('Create a multiple gifts in one tx', function () {
    ...
    describe('Reading data', function () {
      ...
      it('Should return correct data from getGift', async function () {
        ...
        expect((await giftContract.getGift(code('pass3'))).giftID).to.equal(lastGiftID);
      });
    });
